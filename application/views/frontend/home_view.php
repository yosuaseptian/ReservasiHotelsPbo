...
<head>
    <meta charset="utf-8">
    <!-- TITLE -->
    <title>Welcome to Reservasi Hotel Kelompok Aliansi PBO</title>
                        ...
                        <div class="col-lg-9">
                            <div class="availability-form">
                                <div class="vailability-submit">
                                    <a href="<?php echo site_url('rooms');?>" class="awe-btn awe-btn-13">BOOK A ROOM</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section-room-detail bg-white">
            <div class="container">
                ...
                <div class="room-detail_compare">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <div class="room-compare_item">
                                    <div class="img">
                                       <a href="<?php echo site_url('rooms');?>"><img class="img img-responsive" src="<?php echo base_url().'assets/images/'.$j->gambar_large;?>" alt="<?php echo $j->type;?>"></a>
                                    </div>  
                                
                                    <div class="text">
                                        <h2><a herf="<?php echo site_url('rooms');?>"><?php echo $j->type;?></a></h2>
                    ...
                    <a href="<?php echo site_url('rooms');?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">View More</a>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="item">
                            <div class="img">
                                <a href="<?php echo site_url('blog/'.$blog->tulisan_slug);?>"><img class="img-responsive img-full" src="<?php echo base_url().'assets/images/'.$blog->tulisan_gambar;?>" alt="<?php echo $blog->tulisan_judul;?>"></a>
                            </div>
                            <div class="info"><br>
                                <a class="title font-monserat f14 mb20 block bold upper" href="<?php echo site_url('blog/'.$blog->tulisan_slug);?>"><?php echo $blog->tulisan_judul;?></a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach;?>
                ...
                <div class="text-center">
                    <a href="<?php echo site_url('blog');?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">View more</a>
                </div>
            </div>
